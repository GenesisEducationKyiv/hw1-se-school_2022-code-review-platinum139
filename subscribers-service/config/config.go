...
type AppConfig struct {
	...
	DTMCoordinatorAddr     string `env:"DTM_COORDINATOR_ADDR"`
	CustomersServiceAddr   string `env:"CUSTOMERS_SERVICE_ADDR"`
	SubscribersServiceAddr string `env:"SUBSCRIBERS_SERVICE_ADDR"`
}
